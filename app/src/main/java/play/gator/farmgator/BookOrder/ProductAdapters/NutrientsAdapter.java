...
public class NutrientsAdapter extends RecyclerView.Adapter<NutrientsAdapter.FruitHolder>{
    ...
    public NutrientsAdapter(Context context, List<ProductModel> list,String quantity,String finall) {
    ...
    public FruitHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view  = LayoutInflater.from(context).inflate(R.layout.itemnutrients,parent,false);
    ...
    public void onBindViewHolder(final FruitHolder holder, final int position) {
        ...
        holder.nutriensname.setText(productModel.getName());
        holder.nutriensprice.setText(productModel.getPrice());
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                total= number*Integer.parseInt( holder.nutriensprice.getText().toString());
    ...
    public static class FruitHolder extends RecyclerView.ViewHolder{
        ...
        TextView nutriensname,nutriensprice,total,title;
        CheckBox checkBox;
        EditText numberedit;
        ...
        public FruitHolder(View itemView) {
            ...
            nutriensname = itemView.findViewById(R.id.nutriensname);
            total = itemView.findViewById(R.id.nutrienstotal);
            numberedit = itemView.findViewById(R.id.nutriensnumber);
            nutriensprice = itemView.findViewById(R.id.nutriensprice);
    ...
    public List<ProductModel> getFruitsList3(){
        return list;
    }
